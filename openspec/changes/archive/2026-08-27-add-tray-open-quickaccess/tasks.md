...
- [x] 6.1 (ユーザー作業)実機で、ホットキー登録成功時にトレイメニューへ「ホットキー: ⇧⌘Space」の重複表示が出ないことを確認する。(2026-08-27 確認完了、問題なし)
- [x] 6.2 (ユーザー作業)実機で、日本語/英語それぞれのロケールで「クイックアクセスを開く」ラベルが正しく表示されることを確認する。(2026-08-27 確認完了、問題なし)
